package com.nirmalbhetwal.fa_nirmalbhetwal_c0841296_android.listeners;
...
public class UserLocationTouchListener implements RecyclerView.OnItemTouchListener, OnDashboardTouchListener {
    private static final String TAG = "UserLocationTouchListener";
...
//                    vibe.vibrate(100); // do we really need to add vibrate service
    ...
    public UserLocationTouchListener(Activity a, RecyclerView recyclerView) {
        this.act = a;
...
//        mSwipeListener = listener;
        ...
        rView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                /**
                 * This will ensure that this UserLocationTouchListener is paused during recycler view scrolling.
    ...
    public UserLocationTouchListener setClickable(OnRowClickListener listener) {
        this.clickable = true;
        this.mRowClickListener = listener;
        return this;
    }

    public UserLocationTouchListener setClickable(boolean clickable) {
        this.clickable = clickable;
        return this;
    }

    public UserLocationTouchListener setLongClickable(boolean vibrate, OnRowLongClickListener listener) {
        this.longClickable = true;
        this.mRowLongClickListener = listener;
        this.longClickVibrate = vibrate;
        return this;
    }
    public UserLocationTouchListener setLongClickable(boolean longClickable) {
        this.longClickable = longClickable;
        return this;
    }

    public UserLocationTouchListener setIndependentViews(Integer... viewIds) {
        this.independentViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public UserLocationTouchListener setUnClickableRows(Integer... rows) {
        this.unClickableRows = new ArrayList<>(Arrays.asList(rows));
        return this;
    }

    public UserLocationTouchListener setIgnoredViewTypes(Integer... viewTypes) {
    ...
    public UserLocationTouchListener setSwipeable(int foregroundID, int backgroundID, OnSwipeOptionsClickListener listener) {
        this.swipeable = true;
        ...
        if (act instanceof UserLocationTouchListenerHelper)
            ((UserLocationTouchListenerHelper) act).setOnActivityTouchListener(this);
    ...
    public UserLocationTouchListener setSwipeable(boolean value) {
    ...
    public UserLocationTouchListener setSwipeOptionViews(Integer... viewIds) {
        this.optionViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    public UserLocationTouchListener setUnSwipeableRows(Integer... rows) {
    ...
    public UserLocationTouchListener setViewsToFade(Integer... viewIds) {
        this.fadeViews = new ArrayList<>(Arrays.asList(viewIds));
        return this;
    }

    // the entire foreground is faded out as it is opened
    public UserLocationTouchListener setFgFade() {
...
//                        }
    ...
    public interface UserLocationTouchListenerHelper {
